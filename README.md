...
| eq1: | [fCenter, fBandwidth, fGain] | <strong>fCenter:</strong> Center frequency, in hertz. <br><br> <strong>fBandwidth:</strong> Bandwidth, in semitones, in the range from 1 to 36. The default value is 12. <br><br> <strong>fGain:</strong> Gain, in the range from -15 to 15. The default value is 0 dB. |
| eq2: | [fCenter, fBandwidth, fGain] | *Same as eq1* |
| eq3: | [fCenter, fBandwidth, fGain] | *Same as eq1* |
